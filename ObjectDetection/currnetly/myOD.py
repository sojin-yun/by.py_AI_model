...
trainload_dir = '/home/NAS_mount/sjyun/bb_data/trainz.npz'
valid_dir = '/home/NAS_mount/sjyun/bb_data/validz.npz'
...
class RenseNet(nn.Module):
    def __init__(self, block, num_block, growth_rate=12, compression=0.5, num_classes=2):
        ...
        self.linear = nn.Sequential( 
            #nn.Linear(inner_channels, num_classes)
            nn.Linear(inner_channels, int(inner_channels/2)), nn.ReLU(), nn.Dropout(p=0.8), 
